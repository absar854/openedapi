...
You can also add resources to the OpenEd catalog, given that you know the URL of where the resource is hosted.  

The add method takes a hash with resource attributes, listed below.  For example it can be invoked as follows:
